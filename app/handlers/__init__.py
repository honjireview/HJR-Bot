...
"""
    ...
    applicant.register_applicant_handlers(bot)
    council.register_council_handlers(bot)
    review.register_review_handlers(bot)
    text_crafter.register_textcrafter_handlers(bot)
