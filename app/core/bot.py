...
from .db import check_all_connections
from ..handlers import register_all_handlers
from ..services import timer_service, editor_service

log = logging.getLogger("hjr-bot.core")

# --- 2. Инициализация ---
bot = telebot.TeleBot(BOT_TOKEN)
app = Flask(__name__) # Экземпляр Flask создается здесь

# --- 3. Маршруты Flask (вебхук и проверка) ---
